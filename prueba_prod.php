...
<?php
 if(isset($_POST['add_product'])){
   $req_fields = array('product-title','product-categorie','product-quantity','paqt','proveedor');
   ...
   if(empty($errors)){
     ...
     $p_emp   = remove_junk($db->escape($_POST['proveedor']));
     ...
     $query .=" name,quantity,paqt,categorie_id,media_id,id_proveedor,date";
     $query .=") VALUES (";
     $query .=" '{$p_name}', '{$total}','{$paqt}','{$p_cat}', '{$media_id}', '{$p_emp}','{$date}'";
     $query .=")";
     if($db->query($query)){
       $session->msg('s',"Producto agregado exitosamente. ");
       redirect('prueba_prod.php', false);
     } else {
  ...
  <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
         <div class="col-md-12">
          <form method="post" action="prueba_prod.php" class="clearfix">
               ...
               <div class="row">
                 <div class="col-md-2">
                   <div class="input-group">
                     ...
                     <input type="number" class="form-control" name="paqt" placeholder="Paquetes">
                  </div>
                 </div>
