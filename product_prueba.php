      ...
      <div class="panel panel-default">    
        ...
        <strong>
         ...
         <div class="pull-right">         
           ...
           <a href="prueba_prod.php" class="btn btn-primary">Agregar producto</a>
         </div>
        </div>
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th class="text-center" style="width: 10%;"> Cantidad (Paquetes) </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"> <?php echo remove_junk($product['paqt']); ?></td>
