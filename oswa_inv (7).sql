...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-08-2020 a las 23:27:30
...
INSERT INTO `entrada` (`id_entrada`, `id_producto`, `cantidad_inicial`, `cantidad`, `fecha_entrada`) VALUES
(1, 5, 0, 10, '2020-07-15'),
(4, 62, 0, 2, '2020-08-02'),
(7, 57, 0, 5, '2020-08-04');
...
--
-- Estructura de tabla para la tabla `kardex_s`
--

CREATE TABLE `kardex_s` (
  `id` int(11) NOT NULL,
...
(5, 'Cinta de embalaje', 25, 2, 0, '0000-00-00', 1),
...
(14, 'Corrector', 9, 0, 0, '0000-00-00', 1),
...
(38, 'Papel bound A4', 80821, 0, 0, '0000-00-00', 1),
...
(57, 'Borrador chico', 10, 2, 0, '0000-00-00', 1),
...
INSERT INTO `sales` (`id`, `product_id`, `id_emp`, `cantidad_inicial`, `qty`, `stock_final`, `date`) VALUES
(1, 57, 5, 30, 3, 27, '2020-08-05'),
(2, 57, 16, 27, 6, 21, '2020-08-05'),
(4, 57, 19, 21, 7, 14, '2020-08-05'),
(6, 57, 12, 14, 4, 10, '2020-08-05');
...
(1, 'Admin Users', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 1, 'pzg9wa7o1.jpg', 1, '2020-08-05 21:08:21'),
...
--
-- Indices de la tabla `kardex_s`
--
ALTER TABLE `kardex_s`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `kardex_s`
--
ALTER TABLE `kardex_s`
